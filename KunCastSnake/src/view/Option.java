...
public class Option extends JPanel {
	...
	private ImageIcon czbkIcon = new ImageIcon(Option.class.getResource("/kunkun.png"));
	...
	private JRadioButton radioButton_map1 = new JRadioButton();
	private JRadioButton radioButton_map2 = new JRadioButton();
	
	private JButton button_griddingColor = new JButton();
	private JButton button_backgroundColor = new JButton();
	private JButton button_foodColor = new JButton();
	private JButton button_headColor = new JButton();
	private JButton button_bodyColor = new JButton();
	private JButton button_default = new JButton();
